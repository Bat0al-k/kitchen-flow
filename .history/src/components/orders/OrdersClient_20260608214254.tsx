                ...
                <div className="flex flex-col gap-4 md:flex-row md:justify-between md:items-center mb-8">
                    ...
                    <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                        <button
                            ...
                            className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-5 py-2.5 rounded-xl shadow-lg shadow-blue-500/20 transition-all duration-200 border border-blue-400/20 font-medium whitespace-nowrap"
                        >
                            + Create Order
                        </button>
                    </div>
